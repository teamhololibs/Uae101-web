...
<tr>
    ...
    <td width="" >
        <input style="width:95%;" id="<?= $i ?>" class="cat_autocomplete" autocomplete="off" type='text' name="" value="<?= $cat_info['full_name'] ?>" placeholder="Search for category..." title="Category Search"/>
    </td>
    <td  width="20%" >
